...
import static org.openmuc.jdlms.internal.sessionlayer.ServerSessionLayerFactories.newHdlcSessionLayerFactory;
...
public class SnSampleServer {
    ...
    public static void main(String[] args) throws IOException {
        ...
        TcpConnectionBuilder connectionBuiler = new TcpConnectionBuilder("localhost").setTcpPort(port)
                .useHdlc()
