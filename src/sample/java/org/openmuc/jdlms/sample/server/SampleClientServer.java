...
public class SampleClientServer {
    private final static byte[] AUTHENTICATION_KEY = HexConverter
            .fromShortHexString("5468697349734150617373776f726431");

    private final static byte[] GLOBAL_ENCRYPTION_KEY = HexConverter
            .fromShortHexString("000102030405060708090a0b0c0d0e0f");
    private static final byte[] MASTER_KEY = HexConverter.fromShortHexString("aa0102030405060738090a0b0c0d0eff");;
    ...
    static void runDemoClient() throws IOException {
        ...
        if (getResult2.requestSuccessful()) {
            System.err.println(getResult2.getResultData());
        }
        ...
        printClient("new enckey " + HexConverter.toHexString(newKey));
