...
import static org.openmuc.jdlms.internal.AttributeInvokationCtx.saveIntercept;
...
public interface AttributeAccessor {
    ...
    static class LogicalNameFakeAccessor implements AttributeAccessor {
        ...
        private final DataObject logicalName;

        public LogicalNameFakeAccessor(byte[] logicalName) {
            this.logicalName = DataObject.newOctetStringData(logicalName);
        }
    ...
    static class FieldAccessor implements AttributeAccessor {
        ...
        public DataObject get(final CosemClassInstance cosemClassInstance,
            ...
            if (interceptor != null) {
                ...
                DlmsInvocationContext ctx = new AttributeInvokationCtx(securityPolicy, XDlmsServiceType.GET,
                        attributeDesc, instance, this.field, this.cosemAttribute.type()) {
                ...
                result = saveIntercept(interceptor, ctx);
            }
            else {
