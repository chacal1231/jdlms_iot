...
public abstract class ConnectionBuilder<T extends ConnectionBuilder<T>> {
    ...
    public T setChallengeLength(int challengeLength) {
        ...
        if (challengeLength < minLength || challengeLength > maxLength) {
            throw new IllegalArgumentException("Challenge length has to be between " + minLength + " and " + maxLength);
        }
     ...
     * @return the ConnectionBuilder
     */
    public T setManufactureId(String manufactureId) {
    ...
    public T setSystemTitle(String manufacturerId, long deviceId) {
        ...
        systemTitle[3] = (byte) (deviceId >> 4 * 8);
        systemTitle[4] = (byte) (deviceId >> 3 * 8);
        systemTitle[5] = (byte) (deviceId >> 2 * 8);
        systemTitle[6] = (byte) (deviceId >> 1 * 8);
    ...
    protected abstract class SettingsImpl implements Settings {
        ...
        public ConfirmedMode confirmedMode() {
            return ConfirmedMode.CONFIRMED;
        }
