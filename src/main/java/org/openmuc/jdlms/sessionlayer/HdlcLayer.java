...
import org.openmuc.jdlms.internal.sessionlayer.hdlc.HdlcDispatcher.HdlcConnection;
import org.openmuc.jdlms.internal.sessionlayer.hdlc.HdlcDispatcher.HdlcConnectionListener;
...
import org.openmuc.jdlms.internal.sessionlayer.hdlc.HdlcMessageQueue;
...
public class HdlcLayer implements SessionLayer {
    ...
    public synchronized void close() throws IOException {
        ...
        try {
            this.hdlcConnection.close(settings);
        } finally {
            closed = true;
            sendSeqNum = null;
            recSeqNum = null;
